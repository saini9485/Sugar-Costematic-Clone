...
var gifting = document.getElementById("skincare");
// var gifting = document.getElementById("moisture");
...
gifting.addEventListener("click", function (event) {
  fetch(
